...
class Bikes extends React.Component {
	...
	BikeLink = `/admin-bike/${this.props.bike._id}`;
	render() {
		return (
			<>
				<Route exact path='/admin-bike'>
					<ReactBootstrap.Container className='col-md-4 my-2 p-0'>
						<ReactBootstrap.Card className='p-3 col-12 '>
